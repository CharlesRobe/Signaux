...
- Protection des données – Conformément au RGPD, vos enregistrements sont considérés comme des données biométriques. Vous disposez d’un droit d’accès, de rectification, d’opposition et d’effacement.

Règle d'or d'internet : Tout ce qui y est enregistré y reste à jamais.

En procédant à la soumission des fichiers, vous confirmez que vous avez lu et compris ce disclaimer et que vous consentez à la mise à disposition publique de votre enregistrement selon les conditions ci‑dessus.

Si vous n’êtes pas d’accord, veuillez ne pas poursuivre la soumission.

**Enregistrements**

Il faut enregistrer les séquences suivantes :
...
- Ah, j'ai bien mangé ! ; (le « ah » est un « haaa » de satisfaction)

- Chouette, on est mardi ;

- Je veux rentrer.

Soit, vous devriez avoir un total de six fichiers. Ces derniers doivent être de préférence en `.wav` mais ce n'est pas obligatoire, nous pourrons nous charger de la conversion.

Utilisez un logiciel comme audacity ou tout autre application d'enregistrement de fichiers audio et soumettez-les à un des membres de l'équipe.
